...
describe('controller', function () {
	...
	it('should show entries on start-up', function () { // TEST OK
		...
		// toHaveBeenCalledWith() = verifies whether the spied method has been called with the right argument(s)
	});
	...
	describe('routing', function () {
		...
		it('should show active entries', function () { // TEST OK
			setUpModel([todo]);
	...
	it('should highlight "All" filter by default', function () { // TEST OK
		setUpModel([todo]);
	...
	it('should highlight "Active" filter when switching to active view', function () { // TEST OK
		setUpModel([todoList]);
	...
	it('should highlight "completed" filter when switching to completed view', function () { // NEW TEST ADD
		setUpModel([todoList]);
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () { // TEST OK
			setUpModel(todoList);
			...
			for (var i = 0; i < todoList.length; i++) {
				expect(model.update).toHaveBeenCalledWith(todoList[i].id, {
						completed: true // check if all element of todoList are "complete: true"
					},
					jasmine.any(Function));
			}
		});

		it('should update the view', function () { // TEST OK
			setUpModel(todoList);
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () { // TEST OK
			setUpModel([todo]);
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () { // Test OK
			setUpModel([todoList]);
			...
			expect(model.remove).toHaveBeenCalledWith(todoList[0].id, jasmine.any(Function));
		});
